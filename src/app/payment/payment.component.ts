...
export class PaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.service.subBase.subscribe(resp => {
      if (resp) {
        this.base = resp
        // console.log("base in payemnt",this.base)
      }})
      this.service.subFlavours.subscribe(resp => {
        if (resp) {
          this.flavoursAndScoops = resp
        // console.log("flavours in payemnt",this.flavoursAndScoops)
        }})
        ...
        // console.log("base cost final",this.FinalBaseCost)
        ...
        // console.log("this.totalScoopsAmount",this.totalScoopsAmount)
        console.log("final amount",this.totalScoopsAmount+this.FinalBaseCost)
